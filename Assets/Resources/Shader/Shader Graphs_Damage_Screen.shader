...
//
///////////////////////////////////////////
Shader "Shader Graphs/Damage_Screen" {
Properties {
Damage_Fade ("Damage_Fade", Range(0, 1)) = 1
_Rectangle_Size ("Rectangle_Size", Range(0, 1)) = 0.5
_Color ("Color", Color) = (1,0,0,0)
_Texture_Noise ("Texture_Noise", 2D) = "white" { }
_Tiling_Noise ("Tiling_Noise", Vector) = (1,1,0,0)
